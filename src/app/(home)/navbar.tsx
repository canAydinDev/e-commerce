...
const NavbarItem = ({
    ...
    isActive}:NavbarItemProps)=>{
        ...
        return(
            <Button asChild variant="outline" className={cn("bg-transparent hover:bg-transparent rounded-full hover:border-primary border-transparent px-3.5 text-xl",
    ...
    return (
        <nav className="h-20 flex border-b justify-between font-medium bg-white">
            ...
            <div className="hidden lg:flex">
                ...
                <Button asChild variant="secondary" className="border-l border-t-0 border-r-0 px-12 h-full rounded-none bg-black text-white hover:bg-pink-400 hover:text-black transition-colors text-lg">
                    <Link href="/sign-up">
                    Satış Yap
                    </Link>
                </Button>
